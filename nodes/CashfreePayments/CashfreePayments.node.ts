	...
	description: INodeTypeDescription = {
		...
		properties: [
            ...
            },
            {
                ...
                default: '',
                description: 'Customer email address (3-100 characters) (optional)',
            },
            {
                ...
                default: '',
                description: 'Name of the customer (3-100 characters) (optional)',
            },
            {
                ...
                default: '',
                description: 'Order identifier in your system. Alphanumeric, "_" and "-" only (3-45 characters) (optional)',
            },
            {
                ...
                default: '',
                description: 'Order note for reference (3-200 characters) (optional)',
            },
            {
            ...
            },
            {
                ...
                default: '',
                description: 'URL to redirect customer after payment completion (max 250 characters) (optional)',
            },
            {
                ...
                default: '',
                description: 'HTTPS URL for server-to-server notifications (max 250 characters) (optional)',
            },
            {
                ...
                default: '',
                description: 'Comma-separated values: cc,dc,ccc,ppc,nb,upi,paypal,app,paylater,cardlessemi,dcc (optional)',
            ...
            },
            {
                ...
                default: '',
                description: 'Customer bank account. Required for TPV (Third Party Verification) (3-20 characters) (optional)',
            },
            {
                ...
                default: '',
                description: 'Customer bank IFSC. Required for TPV (Third Party Verification) (optional)',
            },
            {
                ...
                default: '',
                description: 'Customer bank code for TPV (Third Party Validation) with NetBanking. Required along with customer_bank_account_number and customer_bank_ifsc for TPV payments (optional)',
            },
            {
                ...
                default: '{}',
                description: 'Complete cart details including cart items, shipping address, billing address, and shipping charges for One Click Checkout integration (optional)',
            ...
            },
            {
                ...
                default: '',
                description: 'Note from customer (optional)',
            },
            {
                ...
                default: '{}',
                description: 'Terminal configuration for SoftPOS orders. Assigns order to specific agent/terminal. Example: {"terminal_id": "cf_terminal_id"} or {"terminal_phone_no": "9876543210"} (optional)',
            ...
            },
            {
                ...
                default: false,
                description: 'Enable One Click Checkout feature (optional)',
            },
            {
                ...
                default: false,
                description: 'Enable Verify and Pay feature (optional)',
            },
            {
                ...
                default: '',
                description: 'A unique identifier for safe retries. If the request fails or times out, you can safely retry it using the same key to avoid duplicate orders (optional)',
            ...
            },
            {
                ...
                type: 'options',
                options: [
                    { name: 'None', value: '' }, // Added empty option to make field truly optional
                    { name: 'State Bank of India (3003)', value: '3003' },
                    { name: 'Punjab National Bank (3005)', value: '3005' },
                    { name: 'Bank of Baroda (3006)', value: '3006' },
                    { name: 'Central Bank of India (3010)', value: '3010' },
            ...
            },
            {
                ...
                default: '',
                description: 'Allowed payment modes for this link. Pass comma-separated values among following options - "cc", "dc", "ccc", "ppc", "nb", "upi", "paypal", "app". Leave it blank to show all available payment methods (optional)',
                placeholder: 'cc,dc,upi,nb',
            },
            {
                ...
                default: false,
                description: 'Enable UPI intent flow (optional)',
            },
            {
                ...
                default: '{}',
                description: 'Custom key-value pairs for internal tracking. Example: {"order_id": "ORD123", "internal_ref": "CUST456"} (optional)',
            ...
            },
            {
                ...
                default: '',
                description: 'A unique identifier for safe retries. If the request fails or times out, you can safely retry it using the same key to avoid duplicate payment links (optional)',
                placeholder: 'UUID format recommended (e.g., 3c90c3cc-0d44-4b50-8888-8dd25736052a)',
            },
            ...
            },
            {
                ...
                default: '',
                description: 'Request ID for the API call. Can be used to resolve tech issues. Communicate this in your tech related queries to Cashfree (optional)',
            },
            {
                displayName: 'Idempotency Key',
                ...
                default: '',
                description: 'An idempotency key is a unique identifier you include with your API call. If the request fails or times out, you can safely retry it using the same key to avoid duplicate actions (optional)',
            ...
            // Get Orders properties - Mandatory fields first
            {
                displayName: 'Link ID',
            ...
            // Optional fields
            {
                ...
                default: 'PAID',
                description: 'What status of orders you want to fetch. ALL - seen as all orders, PAID - seen as only paid orders (optional)',
            },
            {
                displayName: 'Request ID',
            ...
            // Refund properties - Mandatory fields first
            {
                displayName: 'Order ID',
            ...
            // Optional fields
            {
                ...
                default: 'STANDARD',
                description: 'Refund processing speed (optional)',
            },
            {
                ...
                default: '',
                description: 'Refund note for reference (optional)',
            },
            {
                displayName: 'Request ID',
                name: 'x_request_id',
            ...
            // Cashgram properties - Mandatory fields first
            {
            ...
            // Optional fields
            {
                ...
                required: false,
                description: 'Expiry date for the Cashgram link (YYYY-MM-DD format). Maximum 30 days from date of creation (optional)',
            },
            {
                displayName: 'Remarks',
                ...
                required: false,
                description: 'Additional remarks for the Cashgram (optional)',
            },
            {
                ...
                default: 1,
                required: false,
                description: 'Whether to notify the customer about the Cashgram (1 = Yes, 0 = No) (optional)',
            },
